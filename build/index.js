...
var RenderInSeries = function (_React$Component) {
  _inherits(RenderInSeries, _React$Component);

  function RenderInSeries(props) {
    _classCallCheck(this, RenderInSeries);

    var _this = _possibleConstructorReturn(this, (RenderInSeries.__proto__ || Object.getPrototypeOf(RenderInSeries)).call(this, props));
  ...
  return RenderInSeries;
}(_react2.default.Component);

RenderInSeries.propTypes = {
  children: _propTypes2.default.array.isRequired,
  timeline: _propTypes2.default.array.isRequired
};
...
if (process.env.NODE_ENV !== 'production') {
  ...
  module.exports = __webpack_require__(336)(isValidElement, throwOnDirectAccess);
} else {
...
var checkPropTypes = __webpack_require__(338);
